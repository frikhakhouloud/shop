 ...
 */
class getShopAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\ShopAuthenticator' shared autowired service.
     *
     * @return \App\Security\ShopAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'ShopAuthenticator.php';

        return $container->privates['App\\Security\\ShopAuthenticator'] = new \App\Security\ShopAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
